...
<style>
  ...
  label { display: block; font-size: 16px; color: #333; margin-bottom: 3px; }
...
<div class="grid">
  <div class="field"><label>Age</label><input id="age" type="number" value="35"></div>
  <div class="field"><label>Annual Income</label><input id="annual_income" type="number" value="60000"></div>
  <div class="field"><label>Credit Score</label><input id="credit_score" type="number" value="700"></div>
  <div class="field"><label>Existing Debt</label><input id="existing_debt" type="number" value="5000"></div>
  <div class="field"><label>Loan Amount Requested</label><input id="loan_amount_requested" type="number" value="10000"></div>
  <div class="field"><label>Employment Years</label><input id="employment_years" type="number" value="5"></div>
  <div class="field"><label>Debt-to-Income Ratio</label><input id="debt_to_income_ratio" type="number" step="0.01" value="0.08"></div>
  <div class="field"><label>Utilization (3mo avg %)</label><input id="utilization_3mo_avg" type="number" value="30"></div>
  <div class="field"><label>Utilization (6mo avg %)</label><input id="utilization_6mo_avg" type="number" value="28"></div>
  <div class="field"><label>Utilization (12mo avg %)</label><input id="utilization_12mo_avg" type="number" value="25"></div>
  <div class="field"><label>Age WoE score</label><input id="age_woe" type="number" step="0.001" value="0.02"></div>
</div>
